...
#
#  $ bin/test -s foecluster.km -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src foecluster.km.testing.FOECLUSTER_KM_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/foecluster/km/tests/robot/test_example.robot
#
